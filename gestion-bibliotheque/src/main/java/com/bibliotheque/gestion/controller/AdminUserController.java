...
public class AdminUserController {
        ...
        try {
            ...
            if (request.getIdentityCard() != null && !request.getIdentityCard().isEmpty()) {
                ...
                if (userRepository.existsByIdentityCard(request.getIdentityCard()) &&
                        !user.getIdentityCard().equals(request.getIdentityCard())) {
    ...
    private UserDTO convertToDTO(User user) {
        ...
        dto.setIdentityCard(user.getIdentityCard());  // Add this line

        // Convert Set<Role> to Set<String> for DTO
        if (user.getRoles() != null) {
            Set<String> roleNames = user.getRoles().stream()
                    .map(role -> role.getName().toString()) // Convert enum to String
    ...
    public static class UserDTO {
        ...
        private String identityCard;  // Add this field
        ...
        public String getIdentityCard() { return identityCard; }  // Add getter
        public void setIdentityCard(String identityCard) { this.identityCard = identityCard; }  // Add setter
    ...
    public static class UpdateUserRequest {
        ...
        private String firstName;
        private String lastName;
        private String identityCard;  // Change from 'cin' to 'identityCard'
        private String phoneNumber;
        private Boolean enabled;
